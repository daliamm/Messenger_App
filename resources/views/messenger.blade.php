...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="hide-scrollbar">
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                        ...
                                        @php
                                          $letter=subst($frined->name,0,1);
                                          @if($letter != $last_letter)

                                        @endphp
                                        <div class="my-5">
                                            <small class="text-uppercase text-muted">{{$latter}}</small>
                                        </div>
                                        @endif
                                        @php
                                        $last_letter=$latter;
                                                ...
                                                <div class="row align-items-center gx-5">
                                                    <div class="col-auto">
                                                        <a href="#" class="avatar ">
                                                            ...
                                                            <img class="avatar-img" src="a{{$frined->avater_url}}" alt="">
                                                    ...
                                                    <div class="col">
                                                        <h5><a href="#">{{$freind->name}}</a></h5>
                                                        <p>{{$frined->last_seen_at}}</p>
                                                    </div>
      ...
      {{--     
        ...
        var pushre =new Pusher('9bbd071bbb820b9aefl',{
            cluster:'ap2'
            authEndPoint:"/broadcasting/auth"
        });
        var channel =pusher.subscribe(`presence-Messenger.${userId}`);
        channel.bind('new-message',function(date){
