...
//  let obj ={
//     body:msg,
//     creacted_at:moment().format('YYYY-MM-DD hh:mm:ss'),
//     user
//  }
...
const addMessage=function(msg, c  =''){
 ...
 <div class="message-inner">
     ...
     <div class="message-footer">
         <span class="extra-small text-muted">${moment(msg.creacted_at).fromNow()}</span>
     </div>
 </div>
</div>`);
}
        ...
        <div class="row gx-5">
            <div class="col-auto">
                <div class="avatar-group-trigon avatar-group-trigon-sm">
                    ...
                    // <span class="avatar-text">${$chat.participants[0].name}</span>
                    </div>
                </div>
            </div>
...
$('#chat-list').on('click',['data-messages'],function(e){
   ...
   $.get('/api/converations/${id}/messages',function(response){
